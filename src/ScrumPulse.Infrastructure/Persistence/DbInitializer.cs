        ...
        try
        {
            ...
            if (dialect is PostgresSchemaDialect)
            {
                var rawMigrations = new[]
                {
                    ...
                    @"ALTER TABLE ""Blockers"" ADD COLUMN IF NOT EXISTS ""BlockedHours"" numeric NOT NULL DEFAULT 0;",
                    ...
                    @"ALTER TABLE ""Teams"" ADD COLUMN IF NOT EXISTS ""DorChecklistJson"" text NULL;",
                    @"ALTER TABLE ""Teams"" ADD COLUMN IF NOT EXISTS ""DodChecklistJson"" text NULL;",
                    @"ALTER TABLE ""WorkItems"" ADD COLUMN IF NOT EXISTS ""QualityGateResultsJson"" text NULL;",
