# Reviews, Retrospectives & Appreciation Wall

Engineering excellence relies on psychological safety, constructive feedback loops, and a vibrant recognition culture. This guide details ScrumPulse's team culture modules.
...
3. **Client Stakeholder Input**: Perceived delivery reliability, communication clarity, and stakeholder satisfaction.
...
## Feature Module 8: 4-Column Retrospective Board

ScrumPulse provides a purpose-built retrospective board with live collaboration features:

### The 4 Pillars
- **Went Well**: Successes, achievements, and practices the team should continue.
- **Didn't Go Well**: Friction points, missed deadlines, unexpected technical surprises.
- **Ideas & Experiments**: Creative suggestions and procedural hypotheses to test next sprint.
- **Action Items**: Committed improvements with assigned owners and target completion dates.

### Engagement Features
- **Anonymous Card Posting**: Encourages candid, psychological safety-oriented input on sensitive team challenges.
- **Peer Upvoting**: Team members vote on high-priority topics to focus discussion time.
- **Action Item Accountability**: Completed action items are tracked across sprints to ensure retro insights actually drive continuous improvement.

---

## Feature Module 9: Appreciation Wall & Kudos

Recognizing peer contributions elevates morale and strengthens cross-functional camaraderie.
